...
import com.nytimes.android.external.store3.pipeline.StateStore
...
internal open class RealStateStore<S : Any>(initialState: S, final override val coroutineContext: CoroutineContext = Dispatchers.Default) : CoroutineScope, StateStore<S> {
    ...
    override val observable = stateChannel.openSubscription().consumeAsFlow().distinctUntilChanged()
    /**
