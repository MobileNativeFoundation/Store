...
class MutableStoreAcknowledgementTest {
    @Test
    fun newerWriteSurvivesAcknowledgementCommit() =
        runTest {
            val acknowledgement = RaceGate()
            val bLocalReturn = RaceGate()
            val fixture =
                MutableStoreRaceFixture(
                    scope = this,
    ...
    @Test
    fun olderEagerSuccessDoesNotAcknowledgeNewerFailedWrite() =
        runTest {
            val eagerA = RaceGate()
            var aPosts = 0
            var failB = true
    ...
    @Test
    fun failedLocalWriteIsNeverPostedOrAcknowledged() =
        runTest {
            val sequential =
                MutableStoreRaceFixture(
                    scope = this,
            ...
            val failedB =
                assertIs<StoreWriteResponse.Error.Exception>(
    ...
    @Test
    fun acknowledgementIgnoresCreatedOrder() =
        runTest {
            val scope = this
    ...
    @Test
    fun reusedRequestHasDistinctAdmissions() =
        runTest {
            var attempt = 0
            val fixture =
                MutableStoreRaceFixture(
    ...
    @Test
    fun coalescedWaitingCallerReturnsSavedSuccess() =
        runTest {
            val aPost = RaceGate()
            val bLocalReturn = RaceGate()
    ...
    @Test
    fun sameKeyPostsSerializeWithoutBlockingLocalWrites() =
        runTest {
            val aPost = RaceGate()
    ...
    @Test
    fun eagerRetryRechecksAfterExplicitSuccess() =
        runTest {
    ...
    @Test
    fun differentKeysMakeProgressIndependently() =
        runTest {
            val kPost = RaceGate()
            val fixture =
                MutableStoreRaceFixture(
    ...
    @Test
    fun markerOnlyRetryUsesLocalValue() =
        runTest {
            val fixture =
                MutableStoreRaceFixture(
                    scope = this,
    ...
    @Test
    fun eagerRetryUsesLatestLocalValueWithPendingWrites() =
        runTest {
            val fixture =
                MutableStoreRaceFixture(
                    scope = this,
    ...
    @Test
    fun noBookkeeperPreservesExistingEagerBehavior() =
        runTest {
            val fixture =
                MutableStoreRaceFixture(
                    scope = this,
