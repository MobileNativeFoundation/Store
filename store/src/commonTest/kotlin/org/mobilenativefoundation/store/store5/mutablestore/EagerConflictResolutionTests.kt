...
class EagerConflictResolutionTests {
    ...
    @Test
    fun stream_givenConflicts_whenExceptionResolvingConflicts_thenShouldLog() =
        testScope.runTest {
            // Given
    ...
    @Test
    fun stream_givenConflicts_whenErrorMessageResolvingConflicts_thenShouldLog() =
        testScope.runTest {
            // Given
            val latestNote = Note("id", "Title", "Content")
            val readResponse = StoreReadResponse.Data(latestNote, StoreReadResponseOrigin.Cache)
    ...
    @Test
    fun stream_givenNoConflicts_whenCalled_thenShouldLog() =
        testScope.runTest {
            // Given
            val latestNote = Note("id", "Title", "Content")
            val readResponse = StoreReadResponse.Data(latestNote, StoreReadResponseOrigin.Cache)
    ...
    @Test
    fun stream_givenConflicts_whenSuccessResolvingConflicts_thenShouldLog() =
        testScope.runTest {
            // Given
            val latestNote = Note("id", "Title", "Content")
            val readResponse = StoreReadResponse.Data(latestNote, StoreReadResponseOrigin.Cache)
