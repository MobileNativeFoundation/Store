...
class FlowStoreTests {
    ...
    @Test
    fun getAndFresh() = testScope.runTest {
    ...
    @Test
    fun givenNoSourceOfTruthAndCacheHitWhenStreamCachedDataWithoutRefreshThenNoFetchIsTriggeredAndReceivesFollowingNetworkUpdates() = testScope.runTest {
        val fetcher = FakeFetcher(
            3 to "three-1",
            3 to "three-2"
        )
    ...
    @Test
    fun givenSourceOfTruthAndCacheHitWhenStreamCachedDataWithoutRefreshThenNoFetchIsTriggeredAndReceivesFollowingNetworkUpdates() = testScope.runTest {
        val fetcher = FakeFetcher(
            3 to "three-1",
            3 to "three-2"
        )
    ...
    @Test
    fun givenCacheAndNoSourceOfTruthWhen3CachedStreamsWithRefreshAnd1stHasSlowCollectionThen1stStreamsGets3FetchUpdatesAndOtherStreamsGetCacheResultAndFetchResult() =
        testScope.runTest {
            val fetcher = FakeFetcher(
                3 to "three-1",
                3 to "three-2",
    ...
    @Test
    fun givenCacheAndNoSourceOfTruthWhen2CachedStreamsWithRefreshThenFirstStreamsGets2FetchUpdatesAnd2ndStreamGetsCacheResultAndFetchResult() =
        testScope.runTest {
            val fetcher = FakeFetcher(
                3 to "three-1",
                3 to "three-2"
