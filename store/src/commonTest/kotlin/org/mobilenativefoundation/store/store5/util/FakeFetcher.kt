...
class FakeFetcher<Key : Any, Output : Any>(private vararg val responses: Pair<Key, Output>) :
  Fetcher<Key, Output> {
  private var index = 0
...
class FakeFlowingFetcher<Key : Any, Output : Any>(private vararg val responses: Pair<Key, Output>) :
  Fetcher<Key, Output> {
  override val name: String? = null
  override val fallback: Fetcher<Key, Output>? = null
