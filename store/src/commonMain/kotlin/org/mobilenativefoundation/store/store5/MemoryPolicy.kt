...
/**
 * Defines behavior of in-memory [Cache]. Used by [Store].
 *
 * @see [Store]
 */
...
internal constructor(
  ...
  class MemoryPolicyBuilder<Key : Any, Value : Any> {
    ...
    fun setExpireAfterWrite(expireAfterWrite: Duration): MemoryPolicyBuilder<Key, Value> = apply {
    ...
    fun setExpireAfterAccess(expireAfterAccess: Duration): MemoryPolicyBuilder<Key, Value> = apply {
