...
internal class RealStatefulStoreBuilder<Key : StatefulStoreKey, Network : Any, Output : Any, Local : Any>(
    ...
    override fun scope(scope: CoroutineScope): StatefulStoreBuilder<Key, Network, Output, Local> {
        this.scope = scope
        return this
    }

    override fun cachePolicy(memoryPolicy: MemoryPolicy<Key, Output>?): StatefulStoreBuilder<Key, Network, Output, Local> {
        cachePolicy = memoryPolicy
        return this
    }

    override fun disableCache(): StatefulStoreBuilder<Key, Network, Output, Local> {
        cachePolicy = null
        return this
    }

    override fun validator(validator: Validator<Output>): StatefulStoreBuilder<Key, Network, Output, Local> {
        this.validator = validator
        return this
    }

    override fun converter(converter: Converter<Network, Output, Local>): StatefulStoreBuilder<Key, Network, Output, Local> {
        this.converter = converter
        return this
    }
