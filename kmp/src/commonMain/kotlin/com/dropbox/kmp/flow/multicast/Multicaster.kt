...
class Multicaster<T>(
    ...
    // todo - implications of removing lazy initialization
    // failed native platform tests with UnsupportedOperation exception
    // documentation states lazy + mode is supported for jvm/native
