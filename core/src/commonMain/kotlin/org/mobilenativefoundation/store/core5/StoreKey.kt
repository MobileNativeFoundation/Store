...
/**
 * An interface that defines keys used by Store for data-fetching operations. Allows Store to fetch
 * individual items and collections of items. Provides mechanisms for ID-based fetch, page-based
 * fetch, and cursor-based fetch. Includes options for sorting and filtering.
 */
