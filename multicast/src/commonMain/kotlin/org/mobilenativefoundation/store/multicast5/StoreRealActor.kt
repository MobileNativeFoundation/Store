...
/**
 * Simple actor implementation abstracting away Coroutine.actor since it is deprecated. It also
 * enforces a 0 capacity buffer.
 */
@Suppress("EXPERIMENTAL_API_USAGE")
internal abstract class StoreRealActor<T>(scope: CoroutineScope) {
        ...
        try {
          for (msg in it) {
            if (msg === CLOSE_TOKEN) {
              ...
              @Suppress("UNCHECKED_CAST") handle(msg as T)
            }
          }
        } finally {
          doClose()
