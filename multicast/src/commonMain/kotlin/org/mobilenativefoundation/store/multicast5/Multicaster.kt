...
class Multicaster<T>(
  ...
  /** The buffer size that is used only if the upstream has not complete yet. Defaults to 0. */
  bufferSize: Int = 0,
  ...
  /**
   * Gets a new downstream flow. Collectors of this flow will share values dispatched by a single
   * upstream [source] Flow.
   *
